...
from Model.position_embedding import SinusoidalPositionalEmbedding
...
class TransformerEncoder(nn.Module):
    ...
    def forward(self, x_in, x_in_k = None, x_in_v = None):
        ...
        if self.embed_positions is not None:
            # xin_temp = x_in.transpose(0, 1)[:, :, 0]
            a = self.embed_positions(x_in.transpose(0, 1)[:, :, 0]).transpose(0, 1)
